...
internal enum ControlConstants {
    ...
    internal static let bundleVersionFormat = "v%@ · build %@"
    ...
    internal static let localWorkspace = "LOCAL WORKSPACE"
    internal static let readmeSyncCadence = "README sync · every 2 seconds"
    ...
    internal static let repositoryActionsIcon = "slider.horizontal.3"
