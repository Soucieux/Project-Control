...
signature. At that delivery, v2.5/build 16 was recoverable under `build/previous.g6aJIt`. On September 4,
the three superseded v2.6 candidates were removed; the signed app and ten distinct-version recoveries
were retained at that time. The September 6 cleanup later removed every build-folder recovery.
