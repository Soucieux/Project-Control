...
internal enum TestConstants {
    ...
    internal static let checkEmptyRegister = "a folder dropped from a valid register stays listed as an unregistered project"
    internal static let discoveryDirectory = "Discovery"
    internal static let earlierFolder = "Archive tools"
    internal static let laterFolder = "Workbench"
    internal static let hiddenFolder = ".Hidden"
    internal static let readmelessFolder = "history"
    internal static let linkedFolder = "Linked"
    internal static let addedFolder = "Added"
    internal static let checkDiscovery = "every real top-level folder with a README is listed after the register, in name order"
    internal static let checkDiscoveryContent = "an unregistered folder's README fills its tabs and it carries no register metadata"
    internal static let checkDiscoverySkips = "hidden folders, folders without a README, and folder links are not listed"
    ...
    **Change-history numbering:** This project uses dated history.
    ...
    internal static let checkLiveDiscovery = "every top-level folder with a README in the live repository is listed"
    internal static let checkLiveCompleteness = "every live project's README supplies workflows and history: "
